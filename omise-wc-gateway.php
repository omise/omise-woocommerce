    ...
    if ( ! class_exists ( "WC_Gateway_Omise" ) ) {
        class WC_Gateway_Omise extends WC_Payment_Gateway {
            ...
            public function __construct() {
                ...
                $this->sandbox          = isset( $this->settings["sandbox"] ) && "yes" == $this->settings["sandbox"];
                $this->omise_3ds        = isset( $this->settings["omise_3ds"] ) && "yes" == $this->settings["omise_3ds"];
            ...
            function init_form_fields() {
                $this->form_fields = array (
                    ...
                    "title" => array (
                        ...
                        "type"        => "text",
                        "description" => __( "This controls the title user sees during checkout.", $this->gateway_name ),
                        "default"     => __( "Omise Payment Gateway", $this->gateway_name )
                    ),
                    "description" => array (
                        "title"       => __( "Description", $this->gateway_name ),
                        "type"        => "textarea",
                        "description" => __( "This controls the description user sees during checkout.", $this->gateway_name ),
                        "default"     => __( "Omise payment gateway", $this->gateway_name )
                    ),
            ...
            private function is_charge_success( $result ) {
                return isset( $result->id ) && isset( $result->object ) && "charge" == $result->object && true == $result->captured;
            }
            ...
            public function omise_scripts() {
                ...
                wp_enqueue_script(
                    "omise-util",
                    plugins_url( "/assets/javascripts/omise-util.js", __FILE__ ),
                    array(
                        "omise-js"
                    ),
                    OMISE_WOOCOMMERCE_PLUGIN_VERSION,
