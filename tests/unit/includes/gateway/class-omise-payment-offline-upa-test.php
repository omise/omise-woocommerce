...
/**
 * Tests for the UPA integration in Omise_Payment_Offline::process_payment().
 *
 * Uses a concrete test subclass that replicates the UPA process_payment logic
 * to test the branching behavior without loading the full gateway stack.
 *
 * @runTestsInSeparateProcesses
 * @preserveGlobalState disabled
 */
class Omise_Payment_Offline_UPA_Test extends Omise_Test_Case {
	...
	/**
	 * Replicate the UPA process_payment logic from abstract-omise-payment-offline.php
	...
	public function test_process_payment_delegates_to_parent_when_upa_disabled() {
		...
		$gateway->method_title = 'Test Offline';
